...
const addPointsToWinner = async (points, msg, roomId, setShowAlert) => {

  const socket = socketService.getSocket()

  const handlePointsAndAlert = (data) => {
    if (data.room.points.TeamOne[0].turnsWin < 2 && data.room.points.TeamTwo[0].turnsWin < 2) {
      setShowAlert(true);
    }
  };
      ...
      if (!roundsReseted) {
        ...
        axios
          ...
          .then((response) => {
            ...
            handlePointsAndAlert(response.data)
